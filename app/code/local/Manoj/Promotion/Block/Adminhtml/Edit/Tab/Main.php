 ...
 */
class Manoj_Promotion_Block_Adminhtml_Edit_Tab_Main
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('new_field', 'select', array(
            'label'     => Mage::helper('salesrule')->__('New Field'),
            'title'     => Mage::helper('salesrule')->__('New Field'),
            'name'      => 'new_field',
            'options'   => array(
